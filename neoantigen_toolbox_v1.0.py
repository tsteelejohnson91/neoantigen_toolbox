...
def main():
	...
	os.system('mv '+patseq_path+'/tumor_aminodat_metadata '+path+cancer_type+'/'+line[0]+'_'+str(kmer_k)+'mer_metadata.txt')
	os.system('mv '+patseq_path+'/tumor_amino_sorted_dups_hiexpseqs_unq_affinity_clean '+path+cancer_type+'/'+line[0]+'_'+str(kmer_k)+'mer_neoantigens.txt')
	os.system('mv '+patseq_path+'/tumor_amino_sorted_dups '+path+cancer_type+'/'+line[0]+'_'+str(kmer_k)+'mer_tumorpep.txt')
	os.system('mv '+patseq_path+'/normal_amino_sorted_dups '+path+cancer_type+'/'+line[0]+'_'+str(kmer_k)+'mer_normalpep.txt')
